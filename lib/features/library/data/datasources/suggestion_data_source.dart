...
import '../models/suggestion_type_enum.dart';
import '../models/suggestion_lang_enum.dart';
import '../models/suggestion_category_enum.dart';

/// Local data source that holds the static list of suggestions.
/// The list was previously embedded in `LibraryDatabinding` and
/// was moved here to follow a clearer data layer responsibility.
  ...
  List<SuggestionModel> getSuggestions() {
    return [
      ...
      SuggestionModel(
        ...
        url:
            "https://educacao.cemaden.gov.br/midiateca/jogo-na-trilha-do-risco/",
        type: SuggestionTypeEnum.game,
        lang: SuggestionLangEnum.pt,
        category: [SuggestionCategoryEnum.climateEmergency],
      ),
      ...
      SuggestionModel(
        ...
        url:
            "https://www.correiobraziliense.com.br/opinio/2024/03/6819366-impacto-das-mudancas-climaticas-na-biodiversidade-brasileira.html#google_vignette",
        type: SuggestionTypeEnum.news,
        lang: SuggestionLangEnum.pt,
        category: [SuggestionCategoryEnum.climateEmergency],
      ),
      ...
      SuggestionModel(
        ...
        subtitle: "ClimaInfo",
        url:
            "https://climainfo.org.br/2024/10/07/2023-foi-o-ano-mais-seco-para-os-rios-do-planeta-em-30-anos-mostra-omm/",
        type: SuggestionTypeEnum.news,
        lang: SuggestionLangEnum.pt,
        category: [SuggestionCategoryEnum.climateEmergency],
      ),
